...
import { Asset, IReceiverAddress, Network } from '@types';
...
const GeneralLookupDropdown = ({
  ...
  const network = useSelector(getNetwork(asset?.networkId ?? 'Ethereum')) as Network;
    ...
    <Selector
      ...
      value={
        value && value.value
          ...
          : undefined
      } // Allow the value to be undefined at the start in order to display the placeholder
