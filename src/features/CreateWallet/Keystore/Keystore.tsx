...
import { Asset, IRawAccount, ISettings, NetworkId, TAddress, TUuid, WalletId } from '@types';
import { generateDeterministicAddressUUID, makeBlob, stripHexPrefix, withHook } from '@utils';
...
interface Props extends RouteComponentProps {
  ...
  addFavoriteAccount(u: TUuid): void;
...
class CreateKeystore extends Component<Props & INetworkContext & IAssetContext, State> {
  ...
  private addCreatedAccountAndRedirectToDashboard = () => {
    ...
    addFavoriteAccount(accountUUID);
