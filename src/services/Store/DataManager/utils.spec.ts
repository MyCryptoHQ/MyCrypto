...
// import { constructNetworkNodes } from './utils';
...
//   const defaultLs = createDefaultValues(SCHEMA_BASE, NETWORKS);
...
//     const mergedLs = mergeConfigWithLocalStorage(NETWORKS, emptyLs);
...
//       [LSKeys.NETWORKS]: {}
//     } as unknown) as LocalStorage;
//     const mergedLs = mergeConfigWithLocalStorage(NETWORKS, ls);
