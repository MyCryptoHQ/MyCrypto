...
describe('buildTransferEvent', () => {
  ...
  it('correctly includes all values including undefined contacts', () => {
    const result = buildTransferEvent(
      baseExpected.to,
      baseExpected.from,
      baseExpected.asset,
      baseExpected.rate,
      baseExpected.toContact,
      baseExpected.fromContact,
      baseExpected.amount
    );
  ...
  it('correctly includes all values including defined contacts', () => {
    const expected = {
      ...baseExpected,
      to: contacts[0].address as TAddress,
      toContact: contacts[0],
      from: contacts[1].address as TAddress,
