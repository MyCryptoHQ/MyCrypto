...
describe('deriveDisplayAsset', () => {
  ...
  const unknownERC721Asset = generateGenericERC721(
    testToAddr,
  ...
  test('correctly derives known erc20 token transfer display asset', () => {
    ...
    const result = deriveDisplayAsset(
      type,
      testToAddr,
      testNetworkId,
      testChainId,
      [],
      mockGetAssetReturnsERC20
    );
  ...
  test('correctly derives base display asset', () => {
    ...
    const result = deriveDisplayAsset(
      ...
      testNetworkId,
      testChainId,
      [{ to: testToAddr, from: testToAddr, asset: fAssets[1], amount: '1' }],
      mockGetAssetReturnsBase
    );
...
describe('generateGenericBase', () => {
  it('creates a generic base asset from chainID', () => {
    ...
    const genericBase = generateGenericBase('1', 'Ethereum');
