  ...
  const plugins = [
    new HtmlWebpackPlugin({
      ...
      metaCsp: options.isProduction
        ? "default-src 'none'; script-src 'self' 0x.mycrypto.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' 0x.mycrypto.com; manifest-src 'self'; font-src 'self' 0x.mycrypto.com; img-src 'self' data: https://shapeshift.io; connect-src *;"
        : ''
    }),
