  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      metaCsp: IS_DEVELOPMENT
        ? ''
        : "default-src 'self'; script-src 'self'; worker-src 'self' blob:; child-src 'self'; style-src 'self' 'unsafe-inline'; manifest-src 'self'; font-src 'self'; img-src 'self' data: https://mycryptoapi.com/api/v1/images/; connect-src *; frame-src 'self' https://connect.trezor.io;"
    }),
