...
describe('wallet reducer', () => {
  ...
  it('should handle WALLET_BROADCAST_TX_SUCCEEDED', () => {
    ...
    expect(wallet(state, walletActions.broadcastTxSucceded(txHash, signedTx))).toEqual({
      ...INITIAL_STATE,
      transactions: [
        {
          signedTx,
  ...
  it('should handle WALLET_BROADCAST_TX_FAILED', () => {
    ...
    expect(wallet(state, walletActions.broadCastTxFailed(signedTx, errorMsg))).toEqual({
      ...INITIAL_STATE,
      transactions: [
        {
          signedTx,
