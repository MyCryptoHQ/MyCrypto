...
import { TAddress, StoreAccount, StoreAsset, Asset, NodeConfig, INetwork } from 'typeFiles';
...
export const getBaseAssetBalances = async (addresses: string[], network: INetwork | undefined) => {
  if (!network) {
