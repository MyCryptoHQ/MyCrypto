...
import { getNetworkByName, getNetworkByChainId, getAssetByUUID } from 'services/Store';
import { ConfirmTransaction as ConfirmTransactionForm } from 'components/TransactionFlow';
import { toChecksumAddressByChainId } from 'utils';
import { fromWei, ProviderHandler } from 'services/EthService';
import { InlineErrorMsg } from 'components/ErrorMessages';
import { translateRaw } from 'translations';
import { ITxReceipt, ITxConfig } from 'typeFiles';
import { fromTxReceiptObj } from 'components/TransactionFlow/helpers';
