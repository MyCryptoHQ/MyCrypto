...
import { staticNodesReducer, STATIC_NODES_INITIAL_STATE, web3SetNode, web3UnsetNode } from './';
...
describe('static nodes reducer', () => {
  ...
  it('should handle unsetting the web3 node', () =>
    expect(staticNodesReducer(staticNodesExpectedState.setWeb3, actions.web3UnsetNode)).toEqual(
