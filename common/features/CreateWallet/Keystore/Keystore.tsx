...
import { makeBlob, generateUUID } from 'utils';
import { generateKeystore, fromV3 } from 'workers';
import { getNewDefaultAssetTemplateByNetwork, getNetworkByName } from 'services/Store';
...
import { Account, Asset, ISettings, INetwork, NetworkId, WalletId } from 'typeFiles';
import { ROUTE_PATHS, N_FACTOR } from 'config';
...
class CreateKeystore extends Component<Props, State> {
  ...
  private addCreatedAccountAndRedirectToDashboard = () => {
    ...
    const accountNetwork: INetwork | undefined = getNetworkByName(network);
