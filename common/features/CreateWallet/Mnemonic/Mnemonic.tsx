...
import { Account, Asset, DPathFormat, ISettings, WalletId, INetwork, NetworkId } from 'typeFiles';
import { generateUUID } from 'utils';
import { getNewDefaultAssetTemplateByNetwork, getNetworkById } from 'services/Store';
...
class CreateMnemonic extends Component<Props> {
  ...
  private selectNetwork = async (network: NetworkId) => {
    const accountNetwork: INetwork | undefined = getNetworkById(network);
