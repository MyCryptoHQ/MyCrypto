...
module.exports = {
  ...
  data: {
    ...
    CX_Warning_1:
      '반드시 이곳에 보관하는 모든 지갑은 **외부 백업**을 진행해주세요. 이 Chrome 확장 프로그램에서는 확장 프로그램 제거 및 재설치를 포함하여 데이터가 저장되지 않고 손실되는 경우가 자주 발생합니다. 이 확장 프로그램은 쉬운 조작을 제공할 뿐, **백업**을 제공하지 않습니다. ',
    ...
    MNEM_2:
      '하나의 HD Mnemonic 문구에서 여러 가지 지갑/주소를 액세스할 수 있습니다. 액세스하려는 주소를 선택해주세요. ',
    MNEM_more: '나머지 주소 ',
    MNEM_prev: '이전 주소 ',
    ...
    ADD_Ledger_4:
      '설정에서 Browser Support를 확인할 수 없으면, Ledger [Firmware 1.2] (https://www.ledgerwallet.com/apps/manager) 버전이 설치되어 있는지 확인해주세요. ',
    ...
    ADD_Warning_1:
      '지갑 탭은 개인 키를 업로드하지 않고 임의로 모니터링하는 계좌를 추가할 수 있습니다. 이에 따라 지갑의 액세스나 이더리움 전송이 가능하지 않습니다. ',
    ADD_Label_5: '주소 입력 ',
    ...
    SENDModal_Content_4:
      '참고: 에러가 발생한다면, 대부분 토큰 전송에 필요한 가스(수수료, 이더리움으로 결제)가 부족한 것입니다. 이더리움을 계좌에 추가해 주세요. ',
    ...
    OFFLINE_Desc:
      '오프라인 트랜잭션은 3단계로 이루어 집니다. 1, 3 단계는 온라인 컴퓨터로 진행되고, 2 단계는 오프라인/인터넷이 연결되지 않은 컴퓨터로 진행됩니다. 이러한 단계는 개인 키가 인터넷에 연결된 장치에 도달하지 못하도록 합니다. ',
    OFFLLINE_Step1_Title: '1 단계 : 정보 생성하기 (온라인 컴퓨터) ',
    OFFLINE_Step1_Button: '정보 생성 ',
    OFFLINE_Step1_Label_1: '보내는 주소 ',
    OFFLINE_Step1_Label_2:
      '참고: 이것은 받는 주소가 아닌 보내는 주소입니다. Nonce는 원래 계좌에서 생성됩니다. 인터넷에 연결되지 않은 컴퓨터를 사용하는 경우 이 주소는 콜드 스토리지 계좌의 주소가 됩니다. ',
    ...
    OFFLINE_Step2_Label_4b:
      '21000 가스는 기본 설정값입니다. 컨트랙트를 전송하거나 데이터를 더할 때, 사용 가스는 다를 수 있습니다. 사용되지 않은 가스는 환급됩니다. ',
    ...
    NODE_Warning:
      'MyEtherWallet.com을 통해 연결하기 위해서는 HTTPS 노드가 필요합니다. 모든 노드에 연결하려면 [MyEtherWallet 저장소를 다운로드하고 로컬로 실행] (https://github.com/kvhnuke/etherwallet/releases/latest) 할 수 있습니다. 추가로 무료 SSL 인증서를 [LetsEncrypt](https://letsencrypt.org/)에서 받으실 수 있습니다. ',
    NODE_Name: '노드 명 ',
    NODE_Port: '노드 포트 ',
    ...
    /* View Wallet Details */
    VIEWWALLET_Subtitle:
      '다른 버전의 개인 키를 다운로드하거나 종이 지갑 정보를 다시 인쇄할 수 있습니다. [계좌를 Geth/Mist로 가져오기](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)를 진행할 때 필요합니다. 잔액을 확인하려면 [etherscan.io](http://etherscan.io/)과 같은 블록체인 조회 서비스를 사용하는 것을 권장합니다. ',
    ...
    ERROR_21:
      '필요한 가스양을 추정할 수 없습니다. 충분한 자금이 계좌에 없거나 수신 측 컨트랙트에 오류가 있을 수 있습니다. 가스양을 변경한 후 사용해보세요. 전송시 에러 메세지가 반환됩니다. ',
    ...
    ERROR_28:
      '지갑에 액세스하기 위해서는 **Keystore 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://www.myetherwallet.com/#help)를 참고해주세요. ',
    ...
    WARN_Send_Link:
      '주소, 값, 가스, 데이터 필드 또는 트랜잭션 유형 (전송 모드)이 링크를 통해 도착했습니다. 전송하기 전에 정보를 변경할 수 있습니다. 시작하려면 지갑을 열어주세요. ',
    ...
    PARITY_InsufficientBalance:
      '자금이 부족합니다. 트랜잭션을 전송하려는 계좌에 충분한 자금이 없습니다. 필요량: {}, 현재 : {} wei. ',
    ...
    TranslatorName_1:
      '[CoinKorea](https://www.myetherwallet.com/?gaslimit=21000&to=0x0080782b9A9A14f7871Bb765eF7041e784D03F00&value=1.0#send-transaction) · [kanghamin](https://www.myetherwallet.com/?gaslimit=21000&to=0x7B12655A5aada0b3c053C7ff5aa444Bd666A0163&value=1.0#send-transaction) · [maa](https://www.myetherwallet.com/?gaslimit=21000&to=0x14036e41ddb2bd408eaf91597e6dc5220f776ae0&value=1.0#send-transaction) ',
    TranslatorAddr_1: '0x0080782b9A9A14f7871Bb765eF7041e784D03F00 ',
    /* Translator 1             : Insert Comments Here */
    TranslatorName_2:
      '· [Issac](https://www.myetherwallet.com/?gaslimit=21000&to=0x594a7773f4e062ccf644e8f122d5612b5f0db3b2&value=1.0#send-transaction) ',
    TranslatorAddr_2: '0x594a7773f4e062ccf644e8f122d5612b5f0db3b2 ',
    /* Translator 2             : Insert Comments Here */
    TranslatorName_3:
      '· [coinmaker](https://www.myetherwallet.com/?gaslimit=21000&to=0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad&value=1.0#send-transaction) ',
    TranslatorAddr_3: '0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad ',
    /* Translator 3             : Insert Comments Here */
    TranslatorName_4:
      '· [csjune](https://www.myetherwallet.com/?gaslimit=21000&to=0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f&value=1.0#send-transaction) ',
    TranslatorAddr_4: '0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f ',
    /* Translator 4             : Insert Comments Here */
    TranslatorName_5:
      '· [sadfrog](https://www.myetherwallet.com/?gaslimit=21000&to=0x608c96865c3d1364ffc5137e5ac78b57e58714d4&value=1.0#send-transaction) ',
    ...
    HELP_13_Title:
      '13) "잔액 부족. 계좌에 충분한 자금이 없습니다. 필요한 : XXXXXXXXXXXXXXXXXXX 그리고 가지고 있는: XXXXXXXXXXXXXXXXXXX" 는 어떤 의미인가요? ',
    HELP_13_Desc_1:
    ...
    HELP_16_Desc_1:
      '[etherscan.io] (http://etherscan.io/) 와 같은 블록체인 탐색기를 사용할 수 있습니다. 주소를 검색 창에 붙여넣으면 주소와 거래 내역이 표시됩니다. 예를 들어, 우리의 [기부 계정]은 (http://etherscan.io/address/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) 과 같습니다. ',
    ...
    HELP_SecCX_Desc_2:
      '당신이 Chrome 확장 프로그램에 저장한 정보는 [Chrome.storage](http://chrome.storage/)를 통해 저장됩니다. - 이것은 당신이 Chrome에 비밀번호를 저장한 위치와 같은 위치에 저장됩니다. ',
    HELP_SecCX_Desc_3: '어떤 정보가 저장되나요? ',
    HELP_SecCX_Desc_4:
      '주소, 닉네임, 개인 키가 Chrome 스토리지에 저장됩니다. 개인 키는 지갑을 추가할 때 생성된 비밀번호로 암호화됩니다. 닉네임, 지갑 주소는 암호화되지 않습니다. ',
    HELP_SecCX_Desc_5: '닉네임과 지갑 주소는 왜 암호화되지 않나요? ',
    HELP_SecCX_Desc_6:
      '닉네임과 지갑 주소를 암호화하면 계좌 잔액과 닉네임들을 확인할 때마다 비밀번호를 입력해야 합니다. 보안이 걱정된다면 Chrome 확장 프로그램 대신 MyEtherWallet.com 을 사용해주세요. ',
