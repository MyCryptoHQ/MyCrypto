        ...
        <section className="SwapInfo-details row">
          ...
          {!this.isExpanded() && (
            <div className={this.computedClass()}>
              ...
              <p className="SwapInfo-details-block-label">{translateRaw('SEND_amount')}</p>
            </div>
          )}
          ...
          {this.isExpanded() && (
            <div className={this.computedClass()}>
              ...
              <p className="SwapInfo-details-block-label">{translateRaw('SWAP_ref_num')}</p>
            </div>
          )}
          ...
          {this.isExpanded() && (
            <div className={this.computedClass()}>
              ...
              <p className="SwapInfo-details-block-label">{translateRaw('SWAP_time')}</p>
            </div>
          )}
          ...
          <div className={this.computedClass()}>
            ...
            <p className="SwapInfo-details-block-label">{translateRaw('SWAP_rec_amt')}</p>
          </div>
          ...
          <div className={this.computedClass()}>
            ...
            <p className="SwapInfo-details-block-label">{translateRaw('SWAP_your_rate')}</p>
          </div>
        </section>
      </div>
    );
