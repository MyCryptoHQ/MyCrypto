...
export const NODE_CONFIGS: { [key in StaticNetworkIds]: RawNodeConfig[] } = {
  ETH: [
    ...
    //   type: 'rpc',
    //   service: 'MyCrypto',
    //   url: window.location.hostname.match(/(localhost|test)/)
    //     ? 'https://granville.valorbit.com/rpc'
    //     : 'https://ledger.valorbit.com/rpc'
    // }    ,
    {
  ...
  Granville: [
    {
      ...
      type: 'rpc',
      service: 'Valorbit',
      url: 'https://granville.valorbit.com/rpc'
    }
  ],
  ...
  //     type: 'rpc',
  //     service: 'valorbit.com',
  //     url: 'https://nodeapi.valorbit.com'
  //   }
  // ],
