...
export const HOW_TO_BUY_CRYPTO_URL = 'https://support.mycrypto.com/how-to/getting-started/how-to-buy-ether-with-usd';
export const DONT_LOSE_CRYPTO_URL = 'https://support.mycrypto.com/staying-safe/protecting-yourself-and-your-funds';
