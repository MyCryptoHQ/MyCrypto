...
export const StoreProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  // - getBalances should be able to receive just address ? For AddAccount
  // - getBalances network selection with fallbacks ?
  // - update account.asset types
  // - handle polling.
  // - connect to view.
  // - worry about error handling.
  // - save to local storage

  return <StoreContext.Provider value={{ accounts }}>{children}</StoreContext.Provider>;
};
