  ...
  return (
    <Panel basic={true} className="PeaceOfMindPanel">
      ...
      <div className="PeaceOfMindPanel-content">
        ...
        <ContentItem icon={vaultIcon} description={translate('HOME_PEACE_OF_MIND_PROTECT')} />
        <ContentItem icon={vaultIcon} description={translate('HOME_PEACE_OF_MIND_OPENSOURCE')} />
      </div>
