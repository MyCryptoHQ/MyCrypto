...
import { ITxReceipt, IStepComponentProps, TTicker } from 'typeFiles';
import { Amount, TimeElapsedCounter } from 'components';
import { AddressBookContext, AccountContext } from 'services/Store';
