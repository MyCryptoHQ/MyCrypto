...
export default class Helpers extends React.Component<{}, State> {
  public state: State = {
    units: {
      ether: 1
    }
        ...
        <div className="Tab-content">
          <section className="Tab-content-pane">
            <div className="Helper">
              ...
              <UnitInput
                displayUnit="kwei"
                unitValue={units.kwei}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="mwei"
                unitValue={units.mwei}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="gwei"
                unitValue={units.gwei}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="szabo"
                unitValue={units.szabo}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="finney"
                unitValue={units.finney}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="ether"
                unitValue={units.ether}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="kether"
                unitValue={units.kether}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="mether"
                unitValue={units.mether}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="gether"
                unitValue={units.gether}
                onUnitChange={this.convertUnit}
              />
              <UnitInput
                displayUnit="tether"
                unitValue={units.tether}
                onUnitChange={this.convertUnit}
              />
            </div>
          </section>
